...
let Student = function (name, age, hometown) {
  this.name = name; //arrow function won't work because 'this' is bubbling to parent object, which is Window.
  this.age = age; //arrow function won't work because 'this' is bubbling to parent object, which is Window.
  this.hometown = hometown; //arrow function won't work because 'this' is bubbling to parent object, which is Window.
};
...
Student.prototype.greeting = function() {
  return `Hi, my name is ${this.name}`; //again, 'this' is referring to Window Object and not the contextual 'this' of the constructor function.
};
...
// 'this' is referring to an instance (joe) of Student constructor.
// 2. What is "this" when joe.scopeArrow() is invoked?
// 'this' in this case is referring to the window object.
// 3. Explain why "this" is different when an arrow function is used.
// because arrow function contextual 'this' bubble up to the direct parent
